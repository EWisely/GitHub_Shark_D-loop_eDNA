...
metabar_reads_table<-read.csv("data/22-23_Climb2_amplified/04_Usearch_annotated/22-23Climb_dada2_metabar_reads_table.csv", header = TRUE, strip.white = TRUE)
...
#ASVs/motus
Dada2_ecotagged_usearched_results<-read.csv("data/22-23_Climb2_amplified/04_Usearch_annotated/annotated_23bthaps_22-23_results.tab", sep="\t")
...
write.csv(Dada2_ecotagged_usearched_results, "data/22-23_Climb2_amplified/04_Usearch_annotated/annotated_23bthaps_22-23_results.csv")

#aggregate annotations into three new columns, then re-import.
Dada2_ecotagged_usearched_results1<-read.csv("data/22-23_Climb2_amplified/04_Usearch_annotated/annotated_23bthaps_22-23_results_aggregated_annots.csv")
...
Metabar_formatted_samples<-read.csv("data/metadata/22-23_Climb2_sample_metadata.csv", na.strings = c("NA",""))
...
write_csv(pcrs_to_edit, "data/metadata/22-23_Climb2_pcrs_to_edit.csv")
...
pcrs<- read_tsv("data/metadata/22-23_Climb2_pcrs_edited.txt", col_names = TRUE)
...
write.csv(Metabar_formatted_reads, "data/22-23_Climb2_amplified/05_MetabaR_filtered/Metabar_formatted_reads.csv")
write.csv(Metabar_formatted_motus, "data/22-23_Climb2_amplified/05_MetabaR_filtered/Metabar_formatted_motus.csv")
write.csv(Metabar_formatted_pcrs, "data/22-23_Climb2_amplified/05_MetabaR_filtered/Metabar_formatted_pcrs_Climb_22-23.csv")
write.csv(Metabar_formatted_samples, "data/22-23_Climb2_amplified/05_MetabaR_filtered/Metabar_formatted_samples.csv")


Climb_22_23<-metabarlist_generator(reads=Metabar_formatted_reads, Metabar_formatted_motus, pcrs=Metabar_formatted_pcrs, samples=Metabar_formatted_samples)


summary_metabarlist(Climb_22_23)

Climb_22_23$motus$count = colSums(Climb_22_23$reads)
...
Climb_22_23$pcrs$nb_reads <- rowSums(Climb_22_23$reads)

# Compute the number of motus per pcr
Climb_22_23$pcrs$nb_motus <- rowSums(Climb_22_23$reads>0)

#subset the metabarlist to all PCRs with more than 0 reads
Climb_22_23 <- subset_metabarlist(Climb_22_23, table = "pcrs",
                              indices = Climb_22_23$pcrs$nb_reads>0)

summary_metabarlist(Climb_22_23)
save(Climb_22_23, file = "data/22-23_Climb2_amplified/05_MetabaR_filtered/Climb_22_23_Metabarlist.RData")
